...
__decorate([
    swagger_1.ApiProperty({ example: "true", description: "Забанен или нет" }),
...
__decorate([
    swagger_1.ApiProperty({ example: "За хулиганство", description: "Причина блокировки" }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], User.prototype, "banReason", void 0);
__decorate([
    sequelize_typescript_1.BelongsToMany(() => group_model_1.Group, () => user_groups_model_1.UserGroups),
...
__decorate([
    swagger_1.ApiProperty({ example: "Евгений", description: "Имя пользователя" }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "name", void 0);
__decorate([
    swagger_1.ApiProperty({ example: "https:dadsasd", description: "аватар" }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
...
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], User.prototype, "geo_lat", void 0);
__decorate([
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], User.prototype, "geo_lon", void 0);
User = __decorate([
